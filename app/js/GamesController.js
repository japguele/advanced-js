module.exports =  function($scope , GamesFactory,$http){
	...
	this.addGame = function(){
		...
		GamesFactory.addGame(document.getElementById("layout").selected,{name :document.getElementById("name").value},document.getElementById("minplayers").value,document.getElementById("maxplayers").value);
